  ...
  //---------------------------------------------------------------
{
  ...
  for (unsigned int ittbar = 0; ittbar <= nttbar; ittbar++) {
    ...
    */
    ...
    hist_err->Draw("hist");
    TPaveText* pave_err = new TPaveText(0.7,0.62,0.9,0.7,"brNDC");
...
//---------------------------------------------------------------
int simultaneousFit_Z2star(TString date = "", TString version = "", TString decay = "",
...
{  
  ...
  if (date.Length() > 0 && version.Length() > 0 && decay.Length() > 0)  {
    ...
    vector<TString> outDir(3, date+"/"+version+"/"); outDir[0] += "SimultaneousFitEl/"; outDir[1] += "SimultaneousFitMu/"; outDir[2] += "SimultaneousFitAll_Z2star/";
