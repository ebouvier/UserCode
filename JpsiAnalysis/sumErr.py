...
systErr = [
        ...
        ["FSR of $\\text{J}/\\psi$ daughters", 172.650, 172.527],
        ["Jet energy scale (JES)", 172.658, 172.667],
        ["Jet energy resolution (JER)", 172.644, 172.656],
        ["Pile up", 172.554, 172.685],
        #["Muon momentum scale", FIXME, FIXME],
        #["Muon momentum resolution", FIXME, FIXME],
        #["Electron momentum scale", FIXME, FIXME],
        #["Electron momentum resolution", FIXME, FIXME],
