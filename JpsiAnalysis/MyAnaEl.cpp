...
void MyAna::Loop()
{
  ...
  */
  ...
  _h_decay_part->GetXaxis()->SetBinLabel(1, "e + Jets");
  _h_decay_part->GetXaxis()->SetBinLabel(2, "ee + Jets");
  _h_decay_part->GetXaxis()->SetBinLabel(3, "e#mu + Jets");
  ...
  for (Int_t jentry=0; jentry<_nevt;jentry++) { //Starting events loop
    ...
    */
    ...
    _h_iCut->Fill((float)iCut, _weight); cutName[iCut] = ">=1 isolated e"; ++iCut;  
    ...
    */
    ...
    if (isSemiLept) {
      _h_decay->Fill(3.5, _weight);
      _h_decay_part->Fill(0.5, _weight);
    }
    if (isDiLept) {
      if (isDiLept_same) {
        _h_decay->Fill(4.5, _weight);
        _h_decay_part->Fill(1.5, _weight);
      } else {
        _h_decay->Fill(5.5, _weight);
