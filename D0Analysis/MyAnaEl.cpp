...
void MyAna::Loop()
{
  ...
  */
  ...
  _h_isoLept_pt->SetXTitle("p_{T}(isolated e) (GeV)");
  ...
  for (Int_t jentry=0; jentry<_nevt;jentry++) { //Starting events loop
    ...
    _h_iCut->Fill((float)iCut,_weight); cutName[iCut] = "exactly 1 isolated e"; ++iCut;  
    ...
    _h_iCut->Fill((float)iCut,_weight); cutName[iCut] = "no soft #mu"; ++iCut;  
    ...
    _h_iCut->Fill((float)iCut,_weight); cutName[iCut] = "no soft e"; ++iCut;  
    ...
    ++counter[4];
    _h_iCut->Fill((float)iCut,_weight); cutName[iCut] = "#geq4 jets with p_{T}>30 GeV"; ++iCut;  
    ...
    for(unsigned int j = 0; j < ngoodelectron; ++j) {
      ...
      _h_isoLept_pfiso->Fill(electronloose_deltaBetaCorrectedRelIsolation[indgoodel[j]], _weight);
    }
  ...
  cout << "1 iso electron                                            = " << counter[1] << endl;
  cout << "muon veto                                                 = " << counter[2] << endl;
